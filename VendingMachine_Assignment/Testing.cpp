...
int main(int argc, char const *argv[])
{
    ...
    {
        cout << "Selected item: " << testItem << endl;
    ...
    {
        cout << "\nTest case 18" << endl;
        std::array<int,3>  Inventory = {5,5,5};
        std::array<int,3>  Treasury  = {0,1,5};
        VendingMachine VM(Inventory, Treasury);
        std::string coinsinserted = "0N1D1Q\n0N4D1Q";
        std::string itemTobeSelected = "Cola";
        Testing_Repeat_itemSelection(VM,coinsinserted,\
                                    itemTobeSelected);        

        std::array<int,3> testReturnCoins = {0,0,0};
        
        // assert( VM._Return_coins == testReturnCoins);
    }
